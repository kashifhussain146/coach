                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class=""
                                            ...
                                            <tbody style="margin-top: 15px;">
                                                <tr class="">
                                                    <td class="">
                                                        ...
                                                        <img alt="robot picture" class="" height="155"
                                                            src="{{asset('images/coc-logo_1696872523.png')}}"
                                                            width="155">
                                                        </center>
                                                    </td>
                                                </tr>
                                                <tr class="">
                                                        ...
                                                        <td class="headline"><center class="">Welcome to {{env('APP_NAME')}} </center></td>
                                                ...
                                                <tr>
                                                    <td class="" style="color:#444;">
                                                        <p>The password was auto-generated, however feel free to change it
                                                            <a href="{{route('admin.login')}}" style="text-decoration: underline;"> here</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
