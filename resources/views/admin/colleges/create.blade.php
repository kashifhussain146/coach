...
@section('breadcrum')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Colleges Create </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Colleges Create</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content-header">
        <div class="side-app">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class=""><strong> Colleges </strong> </h5><br />
                        <div class="form-group">
                            <label class="form-label">Title *</label>
                            <input type="text" class="form-control" value="{{ isset($loan) ? $loan->name : '' }}"
                                name="name" id="name" placeholder="Title..">
                        </div>
