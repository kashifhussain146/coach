         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                       ...
                       @can('Service Management Module')
                        <li class="nav-item {{ in_array(\Request::route()->getName(), ['category-create','category-list']) ? " menu-open" : ""}}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @can('List Service')
                                <li class="nav-item">
                                    <a href="{{ route('category-list') }}" class="nav-link {{ in_array(\Request::route()->getName(), ['category-list']) ? "active" : ""}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Service</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ in_array(\Request::route()->getName(), ['admin.modules.data.add','admin.modules.data']) ? " menu-open" : ""}}">
                          <a href="#" class="nav-link 
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview ">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.modules.data.add', ['module' => 'library']) }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Colleges</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.modules.data', ['module' => 'library']) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Colleges</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.modules.data', ['module' => 'course-code']) }}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Code</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.modules.data', ['module' => 'course-code']) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Code</p>
                                    </a>
                                </li>
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item {{ in_array(\Request::route()->getName(), ['user-list','user-create','user-edit']) ? " menu-open" : ""}}">
                    <a href="#" class="nav-link ">
                        <i class="nav-icon fas fa-circle"></i>
                        <p>
                            Users Management
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @can('List Users')
                        <li class="nav-item">
                            <a href="{{ route('user-create') }}" class="nav-link {{ in_array(\Request::route()->getName(), ['user-edit','user-create']) ? " active " : ""}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Users</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ in_array(\Request::route()->getName(), ['roles-list','roles-create','roles-edit']) ? " menu-open" : ""}}">
                    <a href="#" class="nav-link ">
                        <i class="nav-icon fas fa-circle"></i>
                        <p>
                            Roles Management
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('roles-create') }}" class="nav-link {{ in_array(\Request::route()->getName(), ['roles-edit','roles-create']) ? " active " : ""}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Roles</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ in_array(\Request::route()->getName(), ['tasks-create','tasks-list','tasks-edit']) ? " menu-open" : ""}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @can('List Tasks')
                        <li class="nav-item  ">
                            <a href="{{ route('tasks-list') }}" class="nav-link {{ in_array(\Request::route()->getName(), ['tasks-list']) ? " active" : ""}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Tasks</p>
                            </a>
                        </li>
