            ...
            <div class="col-md-5">
                ...
                <div class="signup-form-two wow fadeInLeft">
                    ...
                    <form class="mx-4" method="post" action="" id="contact-form">
                        ...
                        <div class="form-group">
                            <button class="theme-btn btn-style-one bg-theme-color4" type="submit" name="submit-form">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div style="padding: 0 5rem;" class="row py-4 justify-content-around position-relative">
        ...
        <div style="width: 58%;" class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <p style="margin: 0 !important; color: black; font-weight: 600;">{{$category->extra_field_10}}</p>
                    <p style="margin: 0.5rem 0 !important; font-size: medium; line-height: 1.5; color: black;">{{$category->extra_field_11}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-3 text-end">
...
$customData = [
                array('colored_title'=>$coloredPart1,'normal_title'=>$rest1,'description'=>$category->extra_field_16),
                array('colored_title'=>$coloredPart2,'normal_title'=>$rest2,'description'=>$category->extra_field_18),
            ];
@endphp
