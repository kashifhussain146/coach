...
class moduleAddAuthorization
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        //     $permission = Permission::firstOrCreate(['name' => "Module_Add_{$moduleSlug}",'parent_id'=>$parent->id]);
        // } catch (\Exception $e) {
        ...
        if (!auth()->guard('admin')->user()->can("Module_Add_{$moduleSlug}")) {
