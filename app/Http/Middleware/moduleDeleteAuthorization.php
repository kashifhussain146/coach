...
class moduleDeleteAuthorization
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        //     //$permission = Permission::firstOrCreate(['name' => "Module_Delete_{$moduleSlug}",'parent_id'=>$parent->id]);
        // } catch (\Exception $e) {
        ...
        if (!auth()->guard('admin')->user()->can("Module_Delete_{$moduleSlug}")) {
